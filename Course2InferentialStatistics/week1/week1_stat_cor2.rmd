...
length(sample_means50$x_bar)
hist(sample_means50$x_bar, main = "Frequency of Sample Means 50 Variable")
```
...
# type your code for this Exercise here, and Run Document
sample_means50 = ames %>%
      rep_sample_n(size = 50, reps = 5000, replace = FALSE) %>%
                    summarise(x_bar = mean(price))
...
sample_means150 = ames %>%
      rep_sample_n(size = 150, reps = 5000, replace = FALSE) %>%
                    summarise(x_bar = mean(price))
