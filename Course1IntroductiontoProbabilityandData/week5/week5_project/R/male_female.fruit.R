...
prop.fruit.ex.male = as.data.frame(table(prop.fruit.ex.male$fruitju1))
...
prop.fruit.ex.female = as.data.frame(table(prop.fruit.ex.female$fruitju1))
...
prop.fruit.vergood.male = as.data.frame(table(prop.fruit.vergood.male$fruitju1))
...
prop.fruit.vergood.female = as.data.frame(table(prop.fruit.vergood.female$fruitju1))
...
prop.fruit.good.male = as.data.frame(table(prop.fruit.good.male$fruitju1))
...
prop.fruit.good.female = as.data.frame(table(prop.fruit.good.female$fruitju1))
...
prop.fruit.fair.male = as.data.frame(table(prop.fruit.fair.male$fruitju1))
...
prop.fruit.fair.female = as.data.frame(table(prop.fruit.fair.female$fruitju1))
...
prop.fruit.poor.male = as.data.frame(table(prop.fruit.poor.male$fruitju1))
...
prop.fruit.poor.female = as.data.frame(table(prop.fruit.poor.female$fruitju1))
